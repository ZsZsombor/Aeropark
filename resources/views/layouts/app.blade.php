...
<body class="bg-background text-foreground min-h-screen transition-colors duration-300">
    <nav class="bg-card shadow-lg border-b border-border transition-colors duration-300">
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <button
                        id="theme-toggle"
                        class="p-2 rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/90 transition-colors"
